...
<head>
    ...
    <title>Login | Warung Bumdes</title>
</head>
...
<div class="flex py-10 md:py-20 px-5 md:px-32 bg-gray-200 min-h-screen">
    <div class="flex shadow w-full flex-col-reverse lg:flex-row">
        <div class="w-full lg:w-1/2 bg-white p-10 px-5 md:px-20">
            <h1 class="font-bold text-xl text-gray-700">Login Warung Bumdes</h1>
            <p class="text-gray-600">Silahkan Masuk Untuk Mulai Berbelanja</p>
            ...
            <form action="/login_member" method="POST" class="mt-10">
                ...
                <div class="my-3">
                    ...
                    <input type="text" placeholder="emailkamu@example.com" name="email" id="email"
                ...
                <div class="flex justify-between">
                    ...
                    <div class="right">
                        <a class="text-blue-400 hover:text-blue-600" href="">Lupa Passsword?</a>
                    </div>
                </div>
                <div class="my-5">
                    <button type="submit"
            ...
            <span>Tidak Memiliki Akun? <a href="/register_member" class="text-blue-400 hover:text-blue-600">Buat Akun.</a></span>
        </div>
